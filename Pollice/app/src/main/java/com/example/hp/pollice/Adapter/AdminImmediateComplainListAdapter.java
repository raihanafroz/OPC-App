...
public class AdminImmediateComplainListAdapter extends ArrayAdapter<String> {
    ...
    public AdminImmediateComplainListAdapter(
        ...
        super(activity, R.layout.admin_immediate_complain_list_row, listArrayID);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.admin_immediate_complain_list_row, null,true);
