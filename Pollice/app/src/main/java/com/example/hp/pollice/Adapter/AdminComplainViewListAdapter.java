...
public class AdminComplainViewListAdapter extends ArrayAdapter<String> {
    ...
    private final String[] listID, listUserName, listEmail, listLatitude, listLongitude, listCause, listComplainAddress, listDescription, listTime, listStationName, listStationId, listAddress, listGender, listUserPhone, listComplainStatus, listComplainID;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.admin_complain_view_list_row, null,true);

        LinearLayout ly = (LinearLayout) rowView.findViewById(R.id.admin_complain_view_list_table_row) ;
        TextView id = (TextView) rowView.findViewById(R.id.admin_complain_view_id);
        TextView email = (TextView) rowView.findViewById(R.id.admin_complain_view_email);
        TextView time = (TextView) rowView.findViewById(R.id.admin_complain_view_time);
        TextView status = (TextView) rowView.findViewById(R.id.admin_complain_view_status);
